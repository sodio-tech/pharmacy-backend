...
export type {Customer} from './customerValidator.js'
export type {Sale} from './newSaleValidator.js'
export type {CustomerDetails} from './updateCustomerValidator.js'
export type {NewProfile} from './updateProfileValidator.js'
export type {OrgProfile} from './updateOrgProfile.js'
export type {BranchUpdates} from './updateBranchValidator.js'
export type {ContactRequest} from './contactRequest.js'
export type {DemoRequest} from './bookDemoValidator.js'
